...
L.Control.Coordinates = L.Control.extend({
  ...
  onAdd: function(map) {
    ...
    //label containers
    this._labelcontainer = L.DomUtil.create("div", "uiElement label",
      container);
    this._label = L.DomUtil.create("span", "labelFirst", this._labelcontainer);


    //input containers
    this._inputcontainer = L.DomUtil.create("div",
      "uiElement input uiHidden", container);
    var xSpan, ySpan, subNoSpan;
    ...
    subNoSpan.innerHTML = options.labelTemplateSub.replace("{subno}", "");
    ...
    if (options.enableUserInput) {
      L.DomEvent.addListener(this._container, "click", this._switchUI,
        this);
    }
  ...
  _handleSubmit: function() {
    var x = L.NumberFormatter.createValidNumber(this._inputX.value, this.options
      .decimalSeperator);
    var y = L.NumberFormatter.createValidNumber(this._inputY.value, this.options
      .decimalSeperator);
  ...
  expand: function() {
    ...
    L.DomEvent.removeListener(this._container, "click", this._switchUI,
      this);
  ...
  _createCoordinateLabel: function(ll) {
    ...
    subNo = L.Util.template(opts.labelTemplateSub, {
      subno: this._getNumber(ll.subno, opts)
    })
  ...
  _update: function(evt) {
    ...
    if (pos) {
      ...
      this._inputY.value = L.NumberFormatter.round(pos.lat, opts.decimals,
        opts.decimalSeperator);
      this._inputX.value = L.NumberFormatter.round(pos.lng, opts.decimals,
        opts.decimalSeperator);
