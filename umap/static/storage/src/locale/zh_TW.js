var locale = {
    ...
    "Custom": "自訂",
    "Default": "預設",
    "Define output link to open a new window on polygon click.": "指定點選多邊形後﹐要在新視窗中開啟的連結。",
    "Delete": "刪除",
    ...
    "Do you want to display the data layers control?": "您是否要顯示資料圖層切換鈕？",
    "Do you want to display the scale control?": "您是否要顯示尺標？",
    "Do you want to display zoom control?": "您是否要顯示地圖縮放鍵？",
    "Double-click to edit": "雙擊開啟編輯功能",
    "Download data": "下載資料",
    "Draw a line": "描繪線條",
    "Draw a marker": "描繪標記",
    ...
    "Fill opacity, from 0.1 to 1.0 (opaque).": "填入不透明度，從 0.1 至 1.0 （完全不透明）",
    "Format": "格式",
    "From zoom": "由縮放大小",
    "Go to home page": "回首頁",
    ...
    "Opacity, from 0.1 to 1.0 (opaque).": "透明度，由 0.1 至 1.0 (不透明)",
    "Optional. Same as color if not set.": "可選，若您未選取顏色，則採用預設值",
    "Optionnal.": "選填",
    "Paste here your data": "在此貼入資料",
    "Path weight in pixels. From 0 to 10.": "設定路徑寬度（畫素），範圍從 0 到 10",
    ...
    "Whether to display or not the Polygon path.": "是否顯示多邊形的路徑",
    "Whether to fill the path with color.": "是否將路徑填入色彩",
    "Zoom in": "放大",
    "Zoom out": "縮小",
    ...
    "smooth factor": "平滑度層級",
    "stroke": "筆畫粗細",
    "symbol of the icon": "圖示的標誌",
    "template to use for the popup": "彈出的範本",
    "type of icon": "圖示的種類",
    "weight": "寬度",
    "yes": "是",
    "Editing": "編輯",
    "Must be a CSS valid name (eg.: DarkBlue or #123456)": "必須為 CSS 所屬的格式（例如：DarkBlue 或 #123456）",
    "Embed the map": "嵌入地圖",
    "Short URL": "短網址",
    ...
    "height": "高度",
    "width": "寬度",
    "Add a permanent label": "新增一個永久的標籤",
    "Clustered": "群集後",
    ...
    "Empty": "空白",
    "Merge geometry with edited feature": "合併地理資訊加入修改過的圖徵",
    "Split line": "分隔線",
    "Clone": "複製",
    ...
    "A string that defines the stroke dash pattern. Ex.: «5, 10, 15».": "以字串格式定義虛線圖樣，例如 «5, 10, 15»。",
    "Do you want to display the «more» control?": "您是否要顯示 《更多》？",
    "Auto": "自動",
    "Autostart slideshow when map is loaded?": "當地圖載入時，自動啟動投影片",
    "Default: name": "預設: name",
    "Delay between elements (in milliseconds)": "各元素間的延遲時間(以毫秒ms為單位)",
    "Property to use for sorting features": "排序圖徵所使用的屬性",
    "Set a value for adding a slideshow": "指定數值新增幻燈片展示",
    "Slideshow": "投影片",
    ...
    "You can use formatting and &#123;properties&#125; from your features.": "您可以用格式化標記與 &#123;屬性&#125; 來作為圖徵使用。",
    ...
    "Click last point to finish shape": "點下最後一點後完成多邊形",
